...
<div className="md:hidden flex justify-center mt-4 px-4">
  <div className="w-full max-w-sm bg-white/5 backdrop-blur-md border border-white/10 rounded-full px-6 py-2">
    <ul className="flex justify-center space-x-6 text-xl text-gray-300">
      ...
      {/* Navbar */}
      <nav className="relative z-10 flex justify-between items-center py-8 px-4 backdrop-blur-sm">
        {/* Navbar links */}
      ...
      {/* Mobile dropdown nav */}
      {isOpen && (
        <div className="md:hidden w-full bg-black/90 backdrop-blur-md py-6 text-center border-t border-white/10">
